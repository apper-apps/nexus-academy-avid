...
const NavLink = ({ to, children, mobile = false }) => {
  ...
  return (
    <nav className="bg-navy-dark border-b border-gray-600">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-8">
              ...
              <NavigationDropdown label="Program" items={programDropdownItems} currentUser={currentUser} />
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              {currentUser ? (
                <>
                  ...
                  {currentUser.is_admin && <NavLink to="/admin" mobile>Admin</NavLink>}
                  <button
                    onClick={() => {
                      onLogout?.();
